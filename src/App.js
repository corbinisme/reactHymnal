...
import {
  ...
  NavbarToggler, Tooltip,
  NavbarBrand, Collapse, ListGroup, ListGroupItem, ButtonGroup, Dropdown, ButtonDropdown, Badge, DropdownItem, DropdownMenu, DropdownToggle, Input, TabContent, TabPane, Card, CardBody, CardHeader, Col, Row, Table, Nav, NavItem, NavLink, CardTitle, CardText, Button
} from 'reactstrap';
//--pages--//
